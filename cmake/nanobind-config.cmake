...
function (nanobind_build_library TARGET_NAME)
  ...
  if (TARGET tsl::robin_map)
    # Target already exists (e.g., provided by user or FetchContent)
    target_link_libraries(${TARGET_NAME} PRIVATE tsl::robin_map)
  elseif (NOT IS_DIRECTORY ${NB_DIR}/ext/robin_map/include OR
      (DEFINED NB_USE_SUBMODULE_DEPS AND NOT NB_USE_SUBMODULE_DEPS))
    # Submodule not available or user explicitly disabled it
